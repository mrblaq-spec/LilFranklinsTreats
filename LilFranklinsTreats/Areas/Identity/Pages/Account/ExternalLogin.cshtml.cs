...
namespace LilFranklinsTreats.Areas.Identity.Pages.Account
{
    [AllowAnonymous]
...
#pragma warning restore IDE0052 // Remove unread private members
        ...
        public async Task<IActionResult> OnPostConfirmationAsync(string returnUrl = "../Customer/Home")
        {
            returnUrl ??= Url.Content("~/");
